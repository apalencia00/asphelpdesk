...
@Component({
  selector: 'app-detalleservicioasignado',
  templateUrl: './detalleservicioasignado.component.html',
  styleUrls: ['./detalleservicioasignado.component.css']
})
export class DetalleservicioasignadoComponent implements OnInit {
